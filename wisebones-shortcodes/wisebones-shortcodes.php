 ...
 * Description:       17 Bootstrap 5 shortcodes — alerts, buttons, cards, accordions, tabs, grid columns, CTA banners, icon boxes, progress bars, testimonials, countdown timers, post grids, modals, badges, dividers, maps, and contact info. Works with any Bootstrap 5 theme; Bootstrap is auto-loaded when not already provided by the active theme.
 * Version:           1.0.3
...
/* ── Auto-load Bootstrap + Icons if not already provided ───── */
...
/* ── Admin: shortcode reference page ───────────────────────── */
...
/* ── Admin notice (plugins page only) ──────────────────────── */
