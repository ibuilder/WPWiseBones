...
class WPWISEBONES_Widget_CTA_Banner extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			__( 'WPWiseBones: CTA Banner', 'wpwisebones' ),
			array( 'description' => __( 'A call-to-action banner with heading, text, and button.', 'wpwisebones' ) )
		);
	}
	...
	public function form( $instance ) {
		$fields = array(
			'title'    => array( __( 'Heading', 'wpwisebones' ), __( 'Need Help?', 'wpwisebones' ) ),
			'text'     => array( __( 'Description', 'wpwisebones' ), __( 'Contact us today.', 'wpwisebones' ) ),
			'btn_text' => array( __( 'Button Text', 'wpwisebones' ), __( 'Get in Touch', 'wpwisebones' ) ),
			'btn_url'  => array( __( 'Button URL', 'wpwisebones' ), '#' ),
			'bg_color' => array( __( 'BG Colour (BS name)', 'wpwisebones' ), 'primary' ),
		);
