    ...
    <footer id="colophon" class="site-footer">
        <?php
        $footer_cols = absint( get_theme_mod( 'wpwisebones_footer_columns', 4 ) );
            ...
            <div class="container d-flex flex-wrap justify-content-between align-items-center gap-3">
                ...
                <div class="footer-social d-flex gap-2">
                    ...
                    foreach ( $socials as $key => $icon ) :
                        $url = get_theme_mod( 'wpwisebones_social_' . $key, '' );
                        if ( $url ) :
                    ?>
...
$wpwisebones_o   = get_option( 'wpwisebones_options', [] );
$show_b2t = isset( $wpwisebones_o['back_to_top'] ) ? (bool) $wpwisebones_o['back_to_top'] : (bool) get_theme_mod( 'wpwisebones_back_to_top', true );
if ( $show_b2t ) : ?>
